...
class PreprocessImage:
    def __init__(self, metrics=['grayscale','remove_noise','thresholding170','thresholding230','dilate','erode','opening','bilateral']):
    ...
    def thresholding(self, image, thres=170):
        return cv2.threshold(image, thres, 255, 1)[1]
    ...
    def transform_image(self, image):
        ...
        for metric in self.metrics:
            ...
            elif metric == 'thresholding170':
                image_np = self.thresholding(image_np, 170)
            elif metric == 'thresholding230':
                image_np = self.thresholding(image_np, 230)
            elif metric == 'dilate':
